              ...
              <ul style={{ listStyleType: "none" }} className="sidebar-inner">
                <li>
                  <button
                    ...
                    onClick={() => navigate("/teacher/display-students")}
                  >
                    Display All Student
                  </button>
                </li>
                ...
                <li>
                  <button
                    type="button"
                    className="sidebar-inner-button"
                    onClick={() => navigate("/teacher/student-marks")}
                  >
                    Student Marks
                  </button>
                </li>
              ...
              <ul style={{ listStyleType: "none" }} className="sidebar-inner">
                <li>
                  <button
                    type="button"
                    className="sidebar-inner-button"
                    onClick={() => navigate("/teacher/display-teachers")}
                  >
              ...
              <ul style={{ listStyleType: "none" }} className="sidebar-inner">
                <li>
                  <button
                    type="button"
                    className="sidebar-inner-button"
                    onClick={() => navigate("/teacher/add-notice")}
                  >
                    Add New Notice
                  </button>
                </li>
                <li>
                  <button
                    type="button"
                    className="sidebar-inner-button"
                    onClick={() => navigate("/teacher/display-notice")}
                  >
                    Display All Notices
                  </button>
                </li>
