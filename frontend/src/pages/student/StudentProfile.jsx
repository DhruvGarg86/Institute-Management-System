...
function StudentProfile() {
    ...
    const validate = () => {
        ...
        // Image already validated on change
                ...
                <div className="card shadow p-4" style={{ maxWidth: '700px', width: '100%' }}>
                    <form onSubmit={handleSubmit} className="row g-3">
                        ...
                        <div className="col-12 d-flex justify-content-center mb-3">
                            <label htmlFor="profilePhoto" style={{ cursor: 'pointer' }} className="text-center">
                        ...
                        <div className="col-md-6">
                            ...
                            <input type="text" className="form-control" value={formData.name} disabled readOnly />
                        </div>

                        <div className="col-md-6">
                            <label className="form-label">Roll No</label>
                            <input type="text" className="form-control" value={formData.rollNo} disabled readOnly />
                        </div>

                        <div className="col-md-6">
                            <label className="form-label">Course</label>
                            <input type="text" className="form-control" value={formData.course} disabled readOnly />
                        </div>
