                      ...
                      return (
                        <div>
                          <button
                            ...
                            onClick={() =>
                              navigate(`/admin/add-student-marks/${props.roll}`)
                            }
                          >
                            Add Marks
                          </button>
                          <button
                            className="btn btn-sm btn-light text-primary me-2"
                            onClick={() =>
                              navigate(`/admin/student-marks/${props.roll}`)
                            }
                          >
                            View Marks
                          </button>
                          <button
                            ...
                            onClick={() =>
                              navigate(`/admin/edit-student/${props.roll}`)
                            }
                          >
                            <FaEdit />
                          </button>
                          <button
                            ...
                            onClick={() =>
                              navigate(`Delete action for:/${props.roll}`)
                            }
                          >
                            <FaTrash />
                          </button>
