                        ...
                        <form className="row g-4 bg-white p-2 rounded admin-add-student-form" onSubmit={updateStudent}>
                            ...
                            <div className="col-md-6">
                                ...
                                <input type="date" name="joining_date" required className="form-control"
                                    value={student.admissionDate} onChange={(e) => setStudent({ ...student, admissionDate: e.target.value })} />
                            </div>
                            ...
                            <div className="col-12 text-center">
                                ...
                                <button onClick={() => navigate('/admin/display-students')} className="ms-2 btn btn-danger px-4 custom-button">
                                    Cancel
                                </button>
                            </div>
                        </form>
